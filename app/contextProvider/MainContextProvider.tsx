...
const MainContextProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
    const [sortCompleted, setSortCompleted] = useState(true);
    ...
    return (
        <MainContext.Provider value={{ sortCompleted, setSortCompleted, nextBtnRef, isMuted, setIsMuted, onPlay, play, pause, audioClickRef, audioTransRef }}>
